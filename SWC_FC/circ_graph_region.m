classdef circ_graph_region< handle
...
%     HideButton;       % Turn all nodes off
  ...
  methods
    function this = circ_graph_region(adjacencyMatrix,varargin)
      % Constructor
      p = inputParser;
